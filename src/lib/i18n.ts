...
const RU: Record<string, string> = {
  ...
  "A portable exe lives wherever it was dropped. This is how you find it again.": "Портативный exe лежит там, куда его положили. Так его потом можно найти.",
  "Add to the Start menu": "Добавить в меню «Пуск»",
  "Puts Lumen in the app list and in search, from where Windows lets you pin it. Applications cannot pin themselves — that was removed from Windows deliberately.": "Помещает Lumen в список приложений и в поиск, откуда Windows позволяет закрепить его. Приложения не могут закреплять себя сами — это убрали из Windows намеренно.",
  "Panel": "Панель",
  "System uses the Windows backdrop below. Solid is a flat colour — the one that looks the same on every Windows version. Transparent removes the panel and leaves the artwork and text floating, which is also what makes a clean OBS overlay.": "«Системная» использует подложку Windows ниже. «Сплошной цвет» одинаково выглядит на любой версии Windows. «Прозрачная» убирает панель и оставляет обложку и текст висеть в воздухе — заодно это лучший вариант для оверлея в OBS.",
  "Solid colour": "Сплошной цвет",
  "Transparent": "Прозрачная",
  "Panel opacity": "Непрозрачность панели",
  "Panel colour": "Цвет панели",
  "The tint behind the glass. Auto follows the album art, like everything else in the capsule.": "Оттенок за стеклом. «Автоматически» следует за обложкой, как и всё остальное в капсуле.",
  "Corner radius": "Радиус углов",
  "Above other windows": "Поверх других окон",
  "Always keeps the capsule over everything, including full-screen games. Only over games stands it down while a game owns the screen — useful if it lands on your crosshair. Bind the hide/show hotkey either way.": "«Всегда» держит капсулу поверх всего, включая полноэкранные игры. «Кроме игр» убирает её, пока игра занимает экран, — полезно, если она попадает на прицел. В любом случае стоит назначить горячую клавишу «скрыть/показать».",
  "Always on top": "Всегда поверх",
  "Except over games": "Кроме игр",
  "Never on top": "Никогда поверх",
  "OBS and streaming": "OBS и стримы",
  "Write now-playing files": "Записывать файлы с текущим треком",
  "Updated on a track change and at no other time.": "Обновляются при смене трека и больше никогда.",
  "Include the cover": "Сохранять обложку",
  "cover.jpg, for an Image source.": "cover.jpg — для источника «Изображение».",
  "Folder": "Папка",
  "Empty writes to an obs folder beside the settings file.": "Пусто — значит в папку obs рядом с файлом настроек.",
  "beside the settings file": "рядом с файлом настроек",
  "Geometry": "Геометрия",
  "Over games, or out of the way": "Поверх игр — или в стороне",
  "The capsule sits above every other window, games included, which is how you can see a track change without leaving a match. If it ever lands somewhere awkward it can stand down for full-screen games instead — and either way, binding the hide/show hotkey in Settings gives you a way to make it vanish and come back.": "Капсула держится поверх всех окон, включая игры, — так смену трека видно, не выходя из матча. Если она мешает, можно убирать её на время полноэкранных игр. И в любом случае стоит назначить в настройках горячую клавишу «скрыть/показать».",
  "Somewhere to find it again": "Чтобы потом найти",
  "Lumen is a single portable file with no installer, which means it lives wherever you put it. A shortcut on the desktop and in the Start menu is how you get it back after the download folder is tidied.": "Lumen — один портативный файл без установщика, он лежит там, куда вы его положили. Ярлык на рабочем столе и в меню «Пуск» — способ вернуться к нему после уборки папки загрузок.",
  Windows: "Windows",
  restart: "перезапуск",
};
...
const PROSE: Record<string, { en: string; ru: string }> = {
  ...
  "hint.obs": {
    en: "OBS cannot capture the capsule itself reliably — it is a layered, topmost window with a system backdrop, and window capture of those gives a black rectangle as often as a picture. So Lumen writes what is playing to plain files instead: point a Text (GDI+) source at nowplaying.txt, an Image source at cover.jpg, or a Browser source at nowplaying.html for a ready-made overlay. Written on a track change and at no other time.",
    ru: "OBS не умеет надёжно захватывать саму капсулу: это слоёное окно поверх всех с системной подложкой, и захват окна для таких даёт чёрный прямоугольник не реже, чем картинку. Поэтому Lumen пишет то, что играет, в обычные файлы: источник «Текст (GDI+)» наведите на nowplaying.txt, «Изображение» — на cover.jpg, а «Браузер» — на nowplaying.html, где уже собран готовый оверлей. Пишутся при смене трека и больше никогда.",
  },
  "hint.hotkeys": {
